                ...
                <div class="flex flex-col w-full">
                    ...
                    <div class="mt-24 flex flex-col w-full px-8 gap-x-4">
                        <div class="flex flex-row items-center gap-x-4 mt-2">
                            <img src="{{ asset('img/hourglass.png') }}" alt="logo" class=" w-8 ">
                            <div class="flex flex-col p-2 items-start ">
                                <h1 class="text-lg font-bold text-emerald-900">Order Ecommerce Proses Setting</h1>
                                <p class="text-sm text-slate-400">Order Ecommerce yang sedang anda kerjakan </p>
                            </div>
                        </div>
                        <div class="flex w-full items-center justify-between bg-white rounded p-4">
                            ...
                            <div id="table_data_ecomm" class="hidden w-full overflow-x-scroll scrollbar-thin scrollbar-thumb-slate-400 text-sm py-4">
                                ...
                                <table id="table_task_ecomm" class="cell-border w-full display nowrap text-left " style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Select</th><th>Status</th><th>No Urut</th><th>Tanggal Order</th><th>Keterangan Order</th>
                                                <th>Nama File</th>
                                            </tr>
                                        </thead>
                                        <tbody>
