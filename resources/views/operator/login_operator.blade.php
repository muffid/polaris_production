    ...
    <div class="max-w-[1700px] mx-auto my-auto flex items-center justify-center h-screen ">
        <div class="flex justify-center items-center h-screen">
            <div class="w-full max-w-xs">
                ...
                @endif
               <h1 class="mx-auto font-bold text-center text-2xl mb-8">Login Operator</h1>
                <form class="bg-white flex flex-col items-center  rounded-xl px-16 pt-6 pb-8 mb-4" method="POST" action="{{ route('login_operator') }}">
                    @csrf
