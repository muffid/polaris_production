<aside id="menu" class="w-72 -ml-72 h-screen overflow-y-scroll overflow-x-auto scrollbar-thin scrollbar-thumb-slate-50  flex flex-col bg-white duration-200  fixed top-0 left-0 gap-y-4 shadow-lg z-20 ">
    ...
    <div class="flex flex-col items-center justify-center gap-y-3">
        ...
        <div class="flex flex-col items-center justify-center">
            <h1 class="text-xl font-bold text-[#084957]">{{$session['user']}}</h1>
    ...
    <div class="w-full flex h-full flex-col py-4 gap-y-2">
       ...
       <div class="flex flex-row items-center justify-start relative ">
        ...
        <div class="flex flex-row items-center justify-start relative cursor-pointer" onclick="window.location.href = '{{ route('master_bahan') }}'">
        ...
        <div class="flex flex-row items-center justify-start relative cursor-pointer" onclick="window.location.href = '{{ route('master_mesin') }}'">
