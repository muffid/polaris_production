          ...
          <div class="flex flex-col gap-y-2">
            ...
            <div class="flex flex-col items-start justify-start">
                ...
                <div class="flex flex-row items-center gap-x-4 px-6 mt-24 ">
                    <img src="{{ asset('img/master_paper.png') }}" alt="logo" class=" w-8 ">
                    <div class="flex flex-col items-start p-2 ">
                        <h1 class="text-lg font-bold text-emerald-900">Master Bahan Cetak</h1>
                        <p class="text-sm text-slate-400">Manage Bahan Cetak</p>
                    </div>
                </div>
                </div>
                ...
                <div class="flex flex-col gap-y-1 w-full">
                    <div class="flex flex-col items-start gap-y-2 md:px-6 py-2 w-full ">
                        <div class="flex flex-col gap-y-4  p-4 bg-white border w-[70%] overflow-x-scroll scrollbar-thin scrollbar-thumb-slate-400 md:rounded-xl ">
                            <div class="mb-3 flex flex-row items-center justify-start lg:justify-start pl-6 w-full">
                                <label class="block text-gray-700 md:w-[25%]  font-bold mb-2 w-full " for="nama-bahan">Nama Bahan :</label>
                            ...
                            <div class="mb-3 flex flex-row items-center justify-start w-full lg:justify-start pl-6">
                                <label class="block text-gray-700 md:w-[25%]  font-bold mb-2 w-full " for="nama-bahan">Lebar Default :</label>
                                <input class="appearance-none border border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nama-bahan" type="text" placeholder="Masukkan nama bahan">
                            </div>
