...
<body class=" bg-[#E9E9E9] relative font-nunito ">
    ...
    <div class=" fixed py-4 px-8  my-auto mx-auto z-50 right-10 top-10 rounded-lg font-bold text-white hidden hidden-div ">
    </div>
    @endif
                                ...
                                <div class="flex flex-col  text-center w-full gap-y-4">
                                    ...
                                    <div class="grid grid-cols-2 p-8 text-sm gap-y-4 items-start w-full bg-white rounded-lg">
                                            ...
                                            <select class=" w-full cursor-pointerappearance-none border text-sm rounded  py-2 px-3 text-gray-700 leading-tight focus:outline-blue-400 focus:shadow-outline" id="bahan" name="bahan">
                                                @for($i=0; $i<sizeof($bahan_cetak); $i++)
                                                    @if($bahan_cetak[$i]->nama_bahan_cetak === $order_unapprove[0]->nama_bahan_cetak)
                                                        <option value="{{ $bahan_cetak[$i]->id_bahan_cetak }}" selected >{{  $bahan_cetak[$i]->nama_bahan_cetak }}</option>
                                                    @else
                                                        <option value="{{ $bahan_cetak[$i]->id_bahan_cetak }}">{{  $bahan_cetak[$i]->nama_bahan_cetak }}</option>
                                                    @endif
                                                @endfor
                                            </select>
                                        </div>
                                        ...
                                        <div class=" flex flex-row items-center justify-between   gap-x-2 px-4 w-full">
                                            ...
                                            <input  value={{$order_unapprove[0]->panjang_bahan}} class="w-full appearance-none border  rounded  py-2 px-3 text-gray-700 leading-tight focus:outline-blue-400 focus:shadow-outline" id="panjang" type="text"  name="panjang" required>
                                            <label for="lebar" class="w-1/3 text-left block text-sm font-medium text-gray-700 ml-4">lebar (cm)</label>
                                            <input  value={{$order_unapprove[0]->lebar_bahan}} class="w-full appearance-none border  rounded  py-2 px-3 text-gray-700 leading-tight focus:outline-blue-400 focus:shadow-outline" id="lebar" type="text"  name="lebar" required>
                                        </div>
                                        <div class=" flex flex-row items-center justify-between   gap-x-2 px-4 w-full">
